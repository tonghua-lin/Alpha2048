...
| 平均分 | 中位数 | 达到 2048 | 达到 4096 | 达到 8192 |
|---:|---:|---:|---:|---:|
...
<p align="center">
  <img src="docs/assets/screen-assistant.png" width="900" alt="Alpha2048 屏幕助手识别外部棋盘并提供实时推荐">
</p>

框选外部 2048 棋盘后，屏幕助手会识别当前数字并持续更新方向推荐；它只提供建议，不会操作外部游戏。
...
默认打包程序使用 CPU。GPU 需要 CUDA，请安装支持 CUDA 的 PyTorch，并用源码自行测试。OCR 始终使用 CPU。
